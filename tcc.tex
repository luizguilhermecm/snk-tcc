...
% ---
\titulo{Otimização de codigo utilizando técnicas de transformação de loops}
...
\newcommand{\listalgorithmnameTCC}{Lista de Algoritmos}
\pdfbookmark[0]{\listalgorithmnameTCC}{lot}
\listofalgorithms
\cleardoublepage
