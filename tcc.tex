...
% ---
\titulo{Otimização de loop utilizando técnicas de transformação de loops}
\tituloingles{Loop otimization with loop transformations techiniques}
\palavraschave{otimizição de loops. tranformação de loops.}
...
% ELEMENTOS PRÉ-TEXTUAIS
 ...
 \pretextual
  ...
  \input{1-capa/3-folha-aprovacao}
...
\input{1-listas/lista-siglas}

%\input{1-listas/lista-simbolos}
...
%\input{2-introducao/relacionados.tex}

\chapter{Fundamentação Teórica}
\input{taxonomia-flynn/taxonomia-flynn}
	
\input{memoria/memoria}

\input{programacao-paralela/programacao-paralela}

\input{data-flow-graph/data-flow-graph}

\input{dependencia/dependencia}
\input{dependencia/dependencia-dados}

\input{loops/reestruturacao-loops}
\input{loops/simple-transformations.tex}
\input{loops/loop-fusion.tex}
\input{loops/loop-fission.tex}
\input{loops/loop-reversal.tex}
\input{loops/loop-interchanging.tex}

\input{resultados/resultados.tex}
\input{resultados/conclusao.tex}
...
% ----------------------------------------------------------
\bibliography{taxonomia-flynn/bib_taxonomia-flynn,2-introducao/bib_introducao,books,memoria/memoria}
