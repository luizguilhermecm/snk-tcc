...
% ---
\titulo{Otimização de código utilizando técnicas de transformação de loops}
...
\membrobancadois{Profa. Dra. Cinthyan Renata S. C. de Barbosa}
\instmembrobancadois{Universidade Estadual de Londrina}
\membrobancatres{Prof. Dr. Evandro Bacarin}
